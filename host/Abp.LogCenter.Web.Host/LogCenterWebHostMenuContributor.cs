...
public class LogCenterWebHostMenuContributor : IMenuContributor
{
    private readonly IConfiguration _configuration;

    public LogCenterWebHostMenuContributor(IConfiguration configuration)
    {
    ...
    {
        var l = context.GetLocalizer<LogCenterResource>();
